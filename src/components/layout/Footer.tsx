        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-cream-300 mb-6 max-w-md">
              2x World's Best Storyteller. Pioneiro do storytelling corporativo no Brasil.
            </p>
            <div className="flex gap-4">
              {Object.entries(SITE_CONFIG.author.socialMedia).map(([platform, url]) => (
                <a
                  key={platform}
                  href={url}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-cream-400 hover:text-accent-gold transition-colors"
                  aria-label={platform}
                >
        ...
        <div className="mt-12 pt-8 border-t border-ink-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-cream-400 text-sm">
              © {currentYear} Fernando Palacios. {t('rights')}
            </p>
